		...
		<Fragment>
			...
			<RadioControl
				...
				options={[
					...
					{
						label: <i className="fas fa-arrow-circle-right"></i>,
					...
					{
						label: <i className="far fa-arrow-alt-circle-down"></i>,
						value: '<i class="far fa-arrow-alt-circle-down"></i>',
					},
					{
						label: <i className="far fa-arrow-alt-circle-left"></i>,
					...
					{
						label: <i className="fas fa-exclamation-circle"></i>,
