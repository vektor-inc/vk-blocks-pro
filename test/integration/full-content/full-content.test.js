	...
	*/
	it( 'should be present for each block', () => {
		...
		getBlockTypes()
			...
			.filter(
				( name ) => ! [ 'core/embed', 'core/template', 'vk-blocks/page-content', 'vk-blocks/post-list', 'vk-blocks/select-post-list-item', 'vk-blocks/child-page', 'vk-blocks/card-item', 'vk-blocks/grid-column-item', 'vk-blocks/step-item', 'vk-blocks/timeline-item', 'vk-blocks/grid-column-item', 'vk-blocks/faq2-a', 'vk-blocks/faq2-q', 'vk-blocks/slider-item', 'vk-blocks/accordion-trigger', 'vk-blocks/accordion-target',  ].includes( name )
			)
			.forEach( ( name ) => {
