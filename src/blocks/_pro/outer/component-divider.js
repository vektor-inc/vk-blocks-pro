const GenerateBgImage = (props) => {
	...
	const { bgImageMobile, bgImageTablet, bgImage, bgSize, blockId, bgFocalPoint } = attributes;
	...
	let backgroundStyle;
	const backgroundPosition = bgFocalPoint 
		? `background-position: ${bgFocalPoint.x * 100}% ${bgFocalPoint.y * 100}% !important;`
