...
require_once dirname( __FILE__ ) . '/blocks/class-vk-blocks-blog-card.php';
VK_Blocks_Blog_Card::init();
require_once dirname( __FILE__ ) . '/App/RestAPI/BlockMeta/class-vk-blocks-pro-entrypoint.php';
