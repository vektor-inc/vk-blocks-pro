...
function vkblocks_blocks_assets() {
	...
	if( is_lager_than_wp('5.0') ){
		...
		$arr = array( 'button', 'pr-blocks', 'outer', 'spacer', 'heading', 'table-of-contents-new', 'highlighter', 'timeline', 'timeline-item', 'step', 'step-item', 'list-style', 'group-style', 'card', 'card-item', 'grid-column', 'grid-column-item', 'icon-card', 'icon-card-item', 'slider', 'slider-item', 'responsive-br', 'nowrap' );
