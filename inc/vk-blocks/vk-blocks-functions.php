...
function vkblocks_blocks_assets() {
	...
	if( is_lager_than_wp('5.0') ){
		...
		$arr = array( 'heading', 'staff', 'highlighter', 'step', 'step-item', 'list-style', 'group-style', 'card', 'card-item', 'icon-card', 'icon-card-item', 'slider', 'slider-item', 'responsive-br', 'nowrap' );
