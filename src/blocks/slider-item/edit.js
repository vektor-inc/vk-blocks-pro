                ...
                >
                    <BaseControl>
                        <RadioControl
                            ...
                            options={[
                                {
                                    label: __('Fit to the Container area', 'vk-blocks-pro'),
                                    value: '0',
                                },
                                {
                                    label: __('Add padding to the Slider area', 'vk-blocks-pro'),
                                    value: '1',
                                },
                                {
                                    label: __('Remove padding from the Slider area', 'vk-blocks-pro'),
                                    value: '2',
                                },
                            ]}
                            onChange={(value) =>
