...
class TaxonomyTest extends WP_UnitTestCase {
	...
	function test_taxonomy_render_callback() {
		...
		$tests = array(
			...
			array(
				'attributes' => array(),
				'correct'    => '<div class="vk_taxonomy vk_taxonomy--category vk_taxonomy-outer-wrap wp-block-vk-blocks-taxonomy"><ul class="vk_taxonomy-list"><li class="cat-item cat-item-20"><a href="' . home_url() . '/?cat=20">empty_category_01</a><ul class="children"><li class="cat-item cat-item-21"><a href="' . home_url() . '/?cat=21">empty_category_01_child</a></li></ul></li><li class="cat-item cat-item-22"><a href="' . home_url() . '/?cat=22">empty_category_02</a><ul class="children"><li class="cat-item cat-item-23"><a href="' . home_url() . '/?cat=23">empty_category_02_child</a></li></ul></li><li class="cat-item cat-item-16"><a href="' . home_url() . '/?cat=16">test_category_01</a><ul class="children"><li class="cat-item cat-item-17"><a href="' . home_url() . '/?cat=17">test_category_01_child</a></li></ul></li><li class="cat-item cat-item-18"><a href="' . home_url() . '/?cat=18">test_category_02</a><ul class="children"><li class="cat-item cat-item-19"><a href="' . home_url() . '/?cat=19">test_category_02_child</a></li></ul></li><li class="cat-item cat-item-1"><a href="' . home_url() . '/?cat=1">Uncategorized</a></li></ul></div>',
			),
			array(
				'attributes' => array(
					'blockLabel'         => '',
			...
			array(
				...
				'correct'    => '<div class="vk_taxonomy vk_taxonomy--category vk_taxonomy-outer-wrap aaaa wp-block-vk-blocks-taxonomy"><select name="cat" id="vk_taxonomy-11" class="vk_taxonomy__input-wrap vk_taxonomy__input-wrap--select"><option value="0">All of Category</option><option class="level-0" value="test_category_01">test_category_01&nbsp;&nbsp;(1)</option><option class="level-0" value="test_category_02">test_category_02&nbsp;&nbsp;(1)</option></select></div><script type="text/javascript">/* <![CDATA[ */( function() {var dropdown = document.getElementById( "vk_taxonomy-11" );function onCatChange() {if ( !!dropdown.options[ dropdown.selectedIndex ].value ) {location.href = "' . home_url() . '/?category=" + dropdown.options[ dropdown.selectedIndex ].value;}}dropdown.onchange = onCatChange;})();/* ]]> */</script>',
			),
		);
