 ...
 */
class PostListSliderBlockTest extends VK_UnitTestCase {
	...
	public function test_post_list() {
		...
		$actual = vk_blocks_post_list_slider_render_callback( $attributes );

		$expected = '<div class="vk_post_list_slider swiper vk_swiper vk_post_list_slider-aaaa vk_post_list_slider-navigation-mobile-bottom vk_post_list_slider-pagination-bullets wp-block-vk-blocks-dynamic-text" data-vk-post-list-slider="{&quot;loop&quot;:true,&quot;effect&quot;:&quot;slide&quot;,&quot;speed&quot;:500,&quot;autoPlay&quot;:true,&quot;autoPlayStop&quot;:false,&quot;autoPlayDelay&quot;:2500,&quot;pagination&quot;:&quot;bullets&quot;,&quot;slidesPerViewMobile&quot;:1,&quot;slidesPerViewTablet&quot;:1,&quot;slidesPerViewPC&quot;:1,&quot;slidesPerGroup&quot;:1,&quot;centeredSlides&quot;:false,&quot;blockId&quot;:&quot;aaaa&quot;}"><div class="swiper-wrapper"><div class="swiper-slide"><div id="post-' . intval( $this->page_id ) . '" class="vk_post vk_post-postType-page card card-post post-' . intval( $this->page_id ) . ' page type-page status-publish hentry"><div class="vk_post_imgOuter" style="background-image:url(' . home_url() . '/wp-content/plugins/vk-blocks-pro/inc/vk-blocks/images/no-image.png)"><a href="' . home_url() . '/?page_id=' . intval( $this->page_id ) . '"><div class="card-img-overlay"></div><img src="' . home_url() . '/wp-content/plugins/vk-blocks-pro/inc/vk-blocks/images/no-image.png" alt="" class="vk_post_imgOuter_img card-img-top" loading="lazy" /></a></div><!-- [ /.vk_post_imgOuter ] --><div class="vk_post_body card-body"><h5 class="vk_post_title card-title"><a href="' . home_url() . '/?page_id=' . intval( $this->page_id ) . '">Page Title<span class="vk_post_title_new">New!!</span></a></h5></div><!-- [ /.card-body ] --></div><!-- [ /.card ] --></div><div class="swiper-slide"><div id="post-' . intval( $this->post_id ) . '" class="vk_post vk_post-postType-post card card-post post-' . intval( $this->post_id ) . ' post type-post status-publish format-standard hentry category-parent_category"><div class="vk_post_imgOuter" style="background-image:url(' . home_url() . '/wp-content/plugins/vk-blocks-pro/inc/vk-blocks/images/no-image.png)"><a href="' . home_url() . '/?p=' . intval( $this->post_id ) . '"><div class="card-img-overlay"></div><img src="' . home_url() . '/wp-content/plugins/vk-blocks-pro/inc/vk-blocks/images/no-image.png" alt="" class="vk_post_imgOuter_img card-img-top" loading="lazy" /></a></div><!-- [ /.vk_post_imgOuter ] --><div class="vk_post_body card-body"><h5 class="vk_post_title card-title"><a href="' . home_url() . '/?p=' . intval( $this->post_id ) . '">Post Title<span class="vk_post_title_new">New!!</span></a></h5></div><!-- [ /.card-body ] --></div><!-- [ /.card ] --></div></div><div class="swiper-button-prev swiper-button-mobile-bottom"></div><div class="swiper-button-next swiper-button-mobile-bottom"></div><div class="swiper-pagination swiper-pagination-bullets"></div></div>';
