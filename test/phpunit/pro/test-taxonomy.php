...
class TaxonomyTest extends WP_UnitTestCase {
	...
	function test_taxonomy_render_callback() {
		...
		$tests = array(
			...
			array(
				'attributes' => array(),
				'correct'    => '<div class="vk_taxonomy vk_taxonomy--category vk_taxonomy-outer-wrap wp-block-vk-blocks-taxonomy"><ul class="vk_taxonomy-list"><li class="cat-item cat-item-' . $data['term_cate_empty_01_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_empty_01_id'] . '">empty_category_01</a></li><li class="cat-item cat-item-' . $data['term_cate_empty_01_child_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_empty_01_child_id'] . '">empty_category_01_child</a></li><li class="cat-item cat-item-' . $data['term_cate_empty_02_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_empty_02_id'] . '">empty_category_02</a></li><li class="cat-item cat-item-' . $data['term_cate_empty_02_child_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_empty_02_child_id'] . '">empty_category_02_child</a></li><li class="cat-item cat-item-' . $data['term_cate_01_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_01_id'] . '">test_category_01</a></li><li class="cat-item cat-item-' . $data['term_cate_01_child_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_01_child_id'] . '">test_category_01_child</a></li><li class="cat-item cat-item-' . $data['term_cate_02_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_02_id'] . '">test_category_02</a></li><li class="cat-item cat-item-' . $data['term_cate_02_child_id'] . '"><a href="http://localhost:8889/?cat=' . $data['term_cate_02_child_id'] . '">test_category_02_child</a></li><li class="cat-item cat-item-1"><a href="http://localhost:8889/?cat=1">Uncategorized</a></li></ul></div>',
			),
			array(
				'attributes' => array(
					'blockLabel'         => '',
