...
class VK_Blocks_ScrollHintRendererTest extends VK_UnitTestCase {
	...
	/**
	 * Test render_with_scroll_hint method with scrollable block.
	 */
	public function test_render_with_scroll_hint() {
		...
		$expected_scroll_hint = '<div class="vk-scroll-hint" data-scroll-breakpoint="table-scrollable-mobile" data-icon-output-left="true" data-icon-output-right="true" data-hint-icon-left="fa-solid fa-caret-left" data-hint-icon-right="fa-solid fa-caret-right">
		...
		$this->assertStringContainsString( $this->normalize_html($expected_scroll_hint), $this->normalize_html($actual_content) );
	}
	...
	public function test_generate_scroll_hint_one_icon_disabled() {
		...
		$expected_scroll_hint = '<div class="vk-scroll-hint" data-scroll-breakpoint="table-scrollable-mobile" data-icon-output-left="false" data-icon-output-right="true" data-hint-icon-right="fa-solid fa-caret-right">
				<span>Scroll to see more</span>
				<i class="fa-solid fa-caret-right"></i>
			</div>';
	...
	public function test_generate_scroll_hint_no_icons() {
		...
		$expected_scroll_hint = '<div class="vk-scroll-hint" data-scroll-breakpoint="table-scrollable-mobile" data-icon-output-left="false" data-icon-output-right="false">
				<span>Scroll to see more</span>
			</div>';
