...
?>
<section>
<h3 id="block-template-setting"><?php echo __( 'Block Template Setting', 'vk-blocks' ); ?></h3>
<ul>
	<li>
		<label>
			...
			<?php echo esc_html_e( 'Hide WordPress Block Template', 'vk-blocks' ) ?>
		</label>
	</li>
	<?php if ( ! empty( $vk_blocks_template ) ) : ?>
		<li>
			<label>
				...
				<?php echo esc_html_e( 'Hide VK Block Template', 'vk-blocks' ) ?>
			</label>
		</li>
	<?php endif;?>
</ul>
