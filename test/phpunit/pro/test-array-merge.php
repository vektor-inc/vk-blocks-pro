...
class ArrayMergeTest extends WP_UnitTestCase {
	...
	public function test_vk_blocks_array_kind() {
		/**
		 *配列の種類を調べるテスト
		 */
		$test_data = array(
		...
		print PHP_EOL;
		print '------------------------------------' . PHP_EOL;
		print 'vk_blocks_array_kind()' . PHP_EOL;
		print '------------------------------------' . PHP_EOL;
		foreach ( $test_data as $test_value ) {

			$return  = vk_blocks_array_kind( $test_value['value']);
			$correct = $test_value['correct'];
	...
	public function test_vk_blocks_multidimensional_min_count() {
		/**
		...
		print PHP_EOL;
		print '------------------------------------' . PHP_EOL;
		print 'vk_blocks_multidimensional_min_count()' . PHP_EOL;
		print '------------------------------------' . PHP_EOL;
		foreach ( $test_data as $test_value ) {

			$return  = vk_blocks_multidimensional_min_count( $test_value['value']);
			$correct = $test_value['correct'];
