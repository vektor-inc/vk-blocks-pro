	...
	*/
	it( 'should be present for each block', () => {
		...
		getBlockTypes()
			...
			.filter(
				(name) => !['core/embed', 'core/template', 'vk-blocks/breadcrumb', 'vk-blocks/page-content', 'vk-blocks/post-list', 'vk-blocks/select-post-list-item', 'vk-blocks/child-page', 'vk-blocks/card-item', 'vk-blocks/grid-column-item', 'vk-blocks/step-item', 'vk-blocks/timeline-item', 'vk-blocks/grid-column-item', 'vk-blocks/icon-card-item', 'vk-blocks/faq2-a', 'vk-blocks/faq2-q', 'vk-blocks/slider-item', 'vk-blocks/accordion-trigger', 'vk-blocks/accordion-target', 'vk-blocks/query', 'vk-blocks/post-template', 'vk-blocks/query-pagination', 'vk-blocks/query-pagination-next', 'vk-blocks/query-pagination-numbers', 'vk-blocks/query-pagination-previous' ].includes( name )
			)
			.forEach( ( name ) => {
