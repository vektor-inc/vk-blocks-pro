...
// 要素の表示・非表示を制御する共通関数
function handleVisibility(item, displayAfterSeconds, hideAfterSeconds, blockId, dontShowAgain) {
...
window.addEventListener('scroll', function () {
	...
	items.forEach((item) => {
		...
		const dontShowAgain = item.getAttribute('data-dont-show-again') === 'true';
