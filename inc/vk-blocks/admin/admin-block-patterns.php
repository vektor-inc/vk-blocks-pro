...
<ul>
	<li>
		<label>
			<input name="vk_blocks_options[hide_wp_block_template]" type="checkbox" <?php checked( $vk_blocks_options['hide_wp_block_template'] ); ?> ></input>
	...
	<?php if ( ! empty( $vk_blocks_template ) ) : ?>
		<li>
			<label>
				<input name="vk_blocks_options[hide_vk_block_template]" type="checkbox" <?php checked( $vk_blocks_options['hide_vk_block_template'] ); ?> ></input>
