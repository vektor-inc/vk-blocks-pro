...
class TaxonomyTest extends WP_UnitTestCase {
	...
	function test_taxonomy_render_callback() {
		...
		$data['cate_id_empty02'] = wp_insert_category( $catarr );
		...
		$catarr                   = array(
			...
			'category_parent' => $data['cate_id_empty02'],
		);
		$data['cate_id_empty02_child'] = wp_insert_category( $catarr );
