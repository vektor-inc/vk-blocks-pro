...
function vkb_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this plugin. Please update the plugin.', 'vk-blocks' ),  // %1$s = plugin name(s).
