	...
	public function test_vk_blocks_blog_card_render_callback(){
		...
		$tests = array(
			...
			array(
				...
				<figure class="wp-block-vk-blocks-blog-card-featured-image"><a href="'. get_permalink(self::$post->ID) .'" target="_self" ><img src=\''. get_the_post_thumbnail_url( self::$post->ID, 'large' ) .'\' /></a></figure>
